	...
	stakeForCharityDialog(0)
{
    updateStyle();
    resize(1000, 740);
    setWindowTitle(tr("Klondike") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Klondike address"));
	...
	pioAction = new QAction(QIcon(":/icons/web"), tr("&Klondike Website"), this);
	pioAction->setToolTip(tr("Visit the Official Klondike website"));
	bitcointalkAction = new QAction(QIcon(":/icons/bitcointalk"), tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk Klondike discussion thread"));
	twitterAction = new QAction(QIcon(":/icons/twitter"), tr("&@Klondike"), this);
	twitterAction->setToolTip(tr("Visit the Official Klondike Twitter"));	
	chainAction = new QAction(QIcon(":/icons/explorer"), tr("&Klondike Slack"), this);
	chainAction->setToolTip(tr("Join Klondike Slack"));	
	githubAction = new QAction(QIcon(":/icons/github"), tr("&Github"), this);
	githubAction->setToolTip(tr("Visit the Official Klondike Github"));	
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Klondike"), this);
    aboutAction->setToolTip(tr("Show information about Klondike"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Klondike"));
...
void BitcoinGUI::createToolBars()
{
	...
	QToolBar *toolbar2 = addToolBar(tr("Klondike top-logo"));
	...
	QToolBar *toolbar4 = addToolBar(tr("Klondike side-logo"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Klondike client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Klondike client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to the Klondike network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(count < nTotalBlocks)
    {
        ...
        if (strStatusBarWarnings.isEmpty())
        {
            ...
            progressBarLabel->setVisible(false);
            progressBar->setFormat(tr("Synchronizing with the Klondike network:   %n block(s) remaining", "", nRemainingBlocks));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Klondike address or malformed URI parameters."));
    }
...
{
    if (!fUseKlondikeTheme)
        return;

    QString qssPath = QString::fromStdString( GetDataDir().string() ) + "/Klondike.qss";
