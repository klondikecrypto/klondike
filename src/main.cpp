...
const string strMessageMagic = "Klondike Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 100) // KLO
    {
        nSubsidy = 50000000 * COIN;
    }
    else if(pindexBest->nHeight < 720000) //   2880 Blocks daily approx. 8 months approx to secure network 
    {
        nSubsidy = 1250 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Klondike", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Klondike Genesis";
        CTransaction txNew;
        txNew.nTime = 1540973724;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xc46db9369f9cb72e64bfcaa53bdd1c19e523aebbcb27f42e3dca7eb77d9a9f13"));
